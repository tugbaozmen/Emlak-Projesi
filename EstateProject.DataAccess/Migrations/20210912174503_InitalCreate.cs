        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                    FaxNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EstateId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EstateName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    NumberOfRoom = table.Column<int>(type: "int", nullable: false),
                    NumberOfBalcony = table.Column<int>(type: "int", nullable: false),
                    NumberOfBathromm = table.Column<int>(type: "int", nullable: false),
                    NumberOfToilet = table.Column<int>(type: "int", nullable: false),
                    NumberOfFloor = table.Column<int>(type: "int", nullable: false),
                    FloorStatus = table.Column<int>(type: "int", nullable: false),
                    WarmStatus = table.Column<byte>(type: "tinyint", nullable: false),
                    Front = table.Column<byte>(type: "tinyint", nullable: false),
                    EstateStatus = table.Column<byte>(type: "tinyint", nullable: false),
